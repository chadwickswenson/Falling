...
static const float BLOCK_HEIGHT = 30.0;
...
- (void)addBrickRow{
    ...
    NSInteger numBrickNeeded = screenWidth/BLOCK_HEIGHT;
    NSInteger leftOrRight = arc4random()%2;
    NSInteger add = arc4random()%4;
    //NSLog(@"%d",leftOrRight);
    NSInteger bricks = 3;
    NSInteger bricksMid = 3;
